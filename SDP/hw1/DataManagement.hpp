...
inline bool isCompatible(const char* uni1, const char* uni2) {
...
inline void append(unsigned short indexQ, const char* name, const char* uni, DynamicArray<LinkedList < Student *>*>& collection) {
...
inline void removeLast(unsigned short indexQ, DynamicArray<LinkedList<Student*>*>& collection) {
    if(indexQ >= collection.getSize()) {
...
inline void removeFirst(unsigned short indexQ, DynamicArray<LinkedList<Student*>*>& collection) {
    if(indexQ >= collection.getSize()) {
        std::cout << "Invalid index of queue!\n" << std::endl;
        return;
    }
...
inline void remove(unsigned short indexQ, const char* name, const char* uni, DynamicArray<LinkedList<Student*>*>& collection) {
    if (indexQ >= collection.getSize()) {
        std::cout << "Invalid index of queue!\n" << std::endl;
        return;
    }
...
inline void merge(unsigned short indexQ1, unsigned short indexQ2, DynamicArray<LinkedList<Student*>*>& collection) {
...
inline void setData(DynamicArray<LinkedList<Student*>*>& collection, const char* file) {
    char command[8];
    char name[128];
    char uni[4];
